...
from scanner.analytics.regime_memory_api import router as regime_memory_router
from scanner.analytics.export_api import router as export_router
...
app.include_router(regime_memory_router)
